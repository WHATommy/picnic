...
export const HousingCard = (props) => {
    ...
    return (
        ...
        <div className="card-body">
            <h5 className="card-title"><i class="bi bi-card-text primary"></i> {props.housing.name}</h5>
        </div>
        <ul className="list-group list-group-flush">
            <li className="list-group-item"><i class="bi bi-geo-alt primary"></i> {props.housing.location}</li>
            <li className="list-group-item"><i class="bi bi-calendar-week primary"></i> {startDate} - {endDate}</li>
            <li className="list-group-item"><i class="bi bi-piggy-bank primary"></i> ${props.housing.cost}</li>
        </ul>
